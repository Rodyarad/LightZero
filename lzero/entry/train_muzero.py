...
def train_muzero(
    ...
    assert create_cfg.policy.type in ['efficientzero', 'muzero', 'muzero_context', 'muzero_rnn_full_obs', 'objectzero_gru', 'sampled_efficientzero', 'sampled_muzero', 'gumbel_muzero', 'stochastic_muzero'], \
    ...
    if create_cfg.policy.type in ['muzero', 'muzero_context', 'muzero_rnn_full_obs', 'objectzero_gru']:
