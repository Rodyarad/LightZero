...
class UniZeroPolicy(MuZeroPolicy):
    ...
    def _forward_learn(self, data: Tuple[torch.Tensor]) -> Dict[str, Union[float, int]]:
        ...
        if self.use_adaptive_entropy_weight:
            ...
            # Weight for the object-mask head loss (must match WorldModel/LossWithIntermediateLosses usage).
            self.mask_loss_weight = float(getattr(self._cfg.model.world_model_cfg, 'mask_loss_weight', 0.0))
    ...
    def _init_collect(self) -> None:
        ...
        # Object-grouping for action masking at the root.
    ...
    def _forward_collect(
        ...
        with torch.no_grad():
            ...
            latent_state_roots, reward_roots, pred_values, policy_logits, mask_logits = mz_network_output_unpack_with_mask(
                network_output
            )
            ...
            noises = [
                np.random.dirichlet(
                    [self._cfg.root_dirichlet_alpha] * dirichlet_sizes[j]
            ...
            for i, env_id in enumerate(ready_env_id):
                ...
                if self._cfg.eps.eps_greedy_exploration_in_collect:
                    ...
                    # Map index in legal set back to concrete action.
