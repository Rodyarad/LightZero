...
import os
os.environ['HF_HOME'] = os.path.expanduser('~/.cache/lightzero/tokenizer_pretrained_vgg')
...
def main(env_id, seed):
    ...
    max_env_step = int(1.5e6) # TODO pong
...
if __name__ == "__main__":
    ...
    args.env = 'PushingNoAgent5x5-v0' # 记忆规划型环境 稀疏奖励
