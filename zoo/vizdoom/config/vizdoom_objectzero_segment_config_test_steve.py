...
def main(env_id, seed):
    ...
    checkpoint_path = 'zoo/ocr/steve_weights/steve_vizdoom.pt'
    ...
    create_config = EasyDict(
        dict(
            env=dict(type='vizdoom_lightzero', import_names=['zoo.vizdoom.env.vizdoom_lightzero_env']),
    ...
    main_config.exp_name = (
        f'data_unizero/{env_id[3:-3]}/{env_id[3:-3]}_steve_uz_nlayer{num_layers}'
