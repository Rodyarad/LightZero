...
gym.envs.registration.register('lift-medium-v0', entry_point='envs.robosuite_env:RobosuiteEnv', kwargs={'use_random_object_position': 'medium'})
gym.envs.registration.register('lift-none-v0', entry_point='envs.robosuite_env:RobosuiteEnv', kwargs={'use_random_object_position': False})
...
class RobosuiteEnv(gym.Env):
    ...
    def __init__(self, use_random_object_position, obs_image_size, time_limit, seed):
        self._robot = 'Panda'
        self._task = 'Lift'

        self._obs_image_size = obs_image_size
        self._horizon = time_limit
        self._initialization_noise_magnitude = 0.5
        ...
        observation_shape = (*self._obs_image_size, 3)
        self.observation_space = gym.spaces.Box(0, 255, observation_shape, dtype=np.uint8)
    ...
    def _process_observation(self, observation):
        ...
        self._last_frame = np.array(Image.fromarray(image).resize(self._obs_image_size))
    ...
    def step(self, action):
        ...
        assert not robosuite_done, f'Episode truncation must be applied in TimeLimit wrapper'
