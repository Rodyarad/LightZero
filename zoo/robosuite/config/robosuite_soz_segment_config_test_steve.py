...
def main(seed):
    ...
    checkpoint_path = 'zoo/ocr/steve_weights/steve_robosuite.pt'
    ...
    create_config = EasyDict(
        dict(
            env=dict(type='robosuite_lightzero', import_names=['zoo.robosuite.env.robosuite_lightzero_env']),
    ...
    main_config.exp_name = (
        f'data_sampled_unizero/robosuite_Lift_steve_brf{buffer_reanalyze_freq}'
