...
def main(seed):
    ...
    create_config = EasyDict(
        dict(
            env=dict(type='causalworld_lightzero', import_names=['zoo.causal_world.env.causalworld_lightzero_env']),
    ...
    main_config.exp_name = (
        f'data_sampled_unizero/causalworld_reaching-hard_steve_brf{buffer_reanalyze_freq}'
