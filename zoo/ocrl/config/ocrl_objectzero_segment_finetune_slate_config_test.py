...
def main(env_id, seed, model_path=None):
    ...
    slate_finetune_config_path = 'zoo/ocr/slate/config/slate_ocrl_finetune.yaml'
    ...
    main_config.exp_name = f'data_unizero/{env_id[3:-3]}/{env_id[3:-3]}_uz_ftslate_nlayer{num_layers}_numsegments-{num_segments}_gsl{game_segment_length}_rr{replay_ratio}_Htrain{num_unroll_steps}-Hinfer{infer_context_length}_bs{batch_size}_seed{seed}'
