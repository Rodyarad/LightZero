...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run a random-policy ManiSkill rollout and save obs/slots/actions with DINOSAUR."
    )
    parser.add_argument("--seed", type=int, default=777)
    parser.add_argument("--max-steps", type=int, default=50)
    parser.add_argument("--checkpoint-path", type=str, default="zoo/ocr/dinosaur_weights/maniskill.ckpt")
